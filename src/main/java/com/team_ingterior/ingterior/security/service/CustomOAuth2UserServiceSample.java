...
import com.team_ingterior.ingterior.security.domain.OAuth2Attribute;
...
public class CustomOAuth2UserServiceSample implements OAuth2UserService<OAuth2UserRequest, OAuth2User>{
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        // 이메일로 가입된 회원인지 조회한다.
        // DTO findMember = memberService.findByEmail(email);
